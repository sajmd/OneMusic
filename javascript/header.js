...
function headerchange(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('musicworld-home').src="../images/login/home-hover.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="white";
		var img=document.getElementById('musicworld-profile').src="../images/login/profile-hover.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="white";
		var img=document.getElementById('music-collaboration').src="../images/login/splitsheet1.jpg";
    
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="white";
		var img=document.getElementById('musicworld-message').src="../images/login/message-hover.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="white";
		var img=document.getElementById('musicworld-notification').src="../images/login/notification-hover.png";
	}
}
...
function headerorigin(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('musicworld-home').src="../images/login/home.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="black";
		var img=document.getElementById('musicworld-profile').src="../images/login/profile.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="black";
		var img=document.getElementById('music-collaboration').src="../images/login/splitsheet2.jpg";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="black";
		var img=document.getElementById('musicworld-message').src="../images/login/message.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="black";
		var img=document.getElementById('musicworld-notification').src="../images/login/notification.png";
	}
}
